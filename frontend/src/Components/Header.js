...
const getName = async () => {
    try {
        const response = await axios.get(`https://employeemanagement-c46a.onrender.com/admin/getAdmin`);
...
const adminLogout = async () => {
    try {
        const response = await axios.post("https://employeemanagement-c46a.onrender.com/admin/adminLogout");
        setlogout(response);
